import scrapy
from ..items import ExpresstribuneSportsItem

class ExpressTribuneSportsSpider(scrapy.Spider):
    name = 'sports'
    start_urls = ['https://tribune.com.pk/Sports?page=1']
    ...
    def parse_news(self, response):
        items = ExpresstribuneSportsItem()
